 ...
 * @author Leonardo
 */
public class frmgod extends javax.swing.JFrame {

    /**
     * Creates new form frmgod
     */
    public frmgod() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmgod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
